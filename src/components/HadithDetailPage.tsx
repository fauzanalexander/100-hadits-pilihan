  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 sm:px-6 animate-fade-in">
      <style>{`
        ...
        .explanation-content i, .explanation-content em {
          font-style: italic;
        }
        .explanation-content b, .explanation-content strong {
          font-weight: bold;
        }
        .explanation-content .font-arabic {
          font-family: 'Noto Naskh Arabic', serif;
        }
        .explanation-content .hadits-arab {
          font-family: 'Noto Naskh Arabic', serif;
          direction: rtl;
          text-align: right;
          font-size: 1.25em;
        ...
        .explanation-content .hadits-terjemah {
            text-align: left;
            font-size: 1em;
            margin-top: 0.5em;
        }
